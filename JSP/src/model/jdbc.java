...
//            queryRecords(con);
    ...
    public static Connection getConnection() throws Exception {
        ...
        String url = "jdbc:mysql://localhost:3306/myjdbc?serverTimezone=UTC";
        String user = "root";
    ...
    private static void updateRecord(Connection con) throws SQLException {
        String sql = "UPDATE EMPLOYEE SET EMP_NAME='修改的名字', "
                + "JOB='测试的工作', SALARY=5000, DEPT='20' "
                + "WHERE EMP_ID=5";
